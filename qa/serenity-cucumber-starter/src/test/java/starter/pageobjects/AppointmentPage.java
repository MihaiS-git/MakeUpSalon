...
public class AppointmentPage extends PageObject {
    ...
    public static final By KARDIGAN_KIM_TREATMENTS = By.xpath("/html/body/app-root/main/div/div/div/div/app-professionals/div/div/app-professionals-list/div[2]/div/app-professionals-detail[1]/div/div/button");
    public static final By TREATMENT_OPTION = By.xpath("/html/body/app-root/main/div/div/div/div/app-professionals/div/div/app-employee-treatments/div[2]/div/app-treatment-detail[1]/div/div/button");
